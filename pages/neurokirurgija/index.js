...
const Neurokirurgija = () => {
  return (
    <div>
      <Head>
        <title>Neurokirurgija - pregled neurokirurga Vrgorac</title>
        <meta
          name="description"
        ...
        <link
          rel="canonical"
          href="https://poliklinikapetrovic.hr/neurokirurgija"
        ></link>
        ...
        <meta
          property="og:url"
          content="https://poliklinikapetrovic.hr/neurokirurgija"
        />
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              url: 'https://poliklinikapetrovic.hr/neurokirurgija',
              description:
        ...
        <div className={wrapper}>
          ...
          <div className={subwrapper}>
            <div className={content}>
              <h1 className={title}>
                {neurokirurgijaPregled.title}:
              </h1>
              <p className={text}>{neurokirurgijaPregled.text}</p>
            </div>
            <div className={content}>
              <a href={'/neurokirurgija/pregled-neurokirurga'}>
            ...
            <div className={content}>
              <a
                href={
                  '/neurokirurgija/epiduralno-steroidna-injekcija'
                }
              >
                <h2 className={subtitle}>
