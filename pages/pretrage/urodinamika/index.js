  ...
  return (
    <div>
      <Head>
        ...
        <meta name="keywords" content="urolog, urologija, urodinamika" />
            ...
            <div className={content}>
              <div className={content}>
                ...
                <p className={text}>
                  ...
                  funkcije donjeg urotrakta (mokraćnog mjehura i mokraćne
                  cijevi). Urodinamika je zlatni standard u otkrivanju
                  poremećaja mokrenja. Metoda je jednostavna, <b>neinvazivna</b>
                  , jeftina i na temelju nje se donosi odluka hoće se pacijent
                ...
                <ul className={ul}>
                  ...
                  <li>Tlaku i volumenu mokraćnog mjehura ( Cistometrija)</li>
                  <li>Protoku mlaza urina ( Mikciometrija ili uroflow )</li>
                  <li>Neurološkom poremećaju mokrenja ( Elektromiografija)</li>
                </ul>
              </div>
              <div className={content}>
                <h2 className={subtitle}>Kako se izgleda urodinamski test?</h2>
                <p className={text}>
                  Od vas će se tražiti da se mokrite u posebnu opremu koja će
                  omogućiti mjerenje. Računalo se koristi za automatsko mjerenje
                  količine i protoka, stvarajući grafikon koji prikazuje sve
                  promjene. Rezultati testa pokazat će imate li slabe mišiće
                  mjehura ili neku vrstu blokade.
                </p>
              </div>
              <div className={content}>
                ...
                <p className={text}>
                  Urodinamski test može biti nelagodan, osobito u vrijeme
                  umetanja, premještanja i uklanjanja katetera mokraćnog mjehura
                  (cijev umetnuta u mokraćni mjehur kroz uretru).
                </p>
              </div>
              <div className={content}>
              ...
              <div className={content}>
                <h2 className={subtitle}>Elektromiografija sfinktera</h2>
                <p className={text}>
