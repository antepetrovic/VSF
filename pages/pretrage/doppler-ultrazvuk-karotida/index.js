        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              '@type': 'Service',
              serviceType:
                'Ultrazvuk karotida: svrha, postupak i rezultati',
        ...
        <div className={wrapper}>
          ...
          <div className={subwrapper}>
            <div className={content}>
              ...
              <p className={text}>
                Korištenjem zvučnih valova, ultrazvuk karotida je
                bezbolan i siguran način provjere vaših karotidnih
                arterija ― koje opskrbljuju vaš mozak krvlju.
              </p>
              <p className={text}>
                Ultrazvuk karotidnih arterija koristi se za procjenu
                glavnih arterija vrata koje dovode oksigeniranu krv u
                mozak. Ponekad se ove arterije mogu suziti zbog
                nakupljanja plaka. Sužavanje krvnih žila može povećati
                rizik od moždanog udara. Ultrazvučni pregled karotide
                može pokazati
                <b> postoje li suženja ili začepljenja</b> u dvjema
                arterijama vrata koje vode do vašeg mozga. Doppler
                karotida može pomoći liječnicima da utvrde rizik od
                moždanog udara i potrebu za preventivnim mjerama.
              </p>
              <p className={text}>
                Kada je potreban ultrazvuk karotida, on bi se trebao
                <b> napraviti u što kraćem roku </b> jer ranija
                dijagnoza može dovesti do ranog liječenja i ponekad
                spasiti živote.
              </p>
              <p className={text}>
                Ultrazvuk karotida arterija pokazuje vašem liječniku
                može pokazati vašem liječniku:
              </p>
              <ul className={ul}>
                <li>
                  Jesu li karotidne arterije začepljene ili sužene
                </li>
                <li>
                  Izmjeriti koliko dobro krv teče kroz vaše arterije
                </li>
              </ul>
            </div>
            <div className={content}>
              <h2 className={subtitle}>
                KADA NAPRAVITI ULTRAZVUK KAROTIDA
              </h2>
              <p className={text}>
                Ultrazvuk karotidnih arterija je potreban kada vaš
                liječnik želi potražiti krvne ugruške ili naslage
                masti i kolesterola na stijenkama karotidne arterije.
                Ove naslage mogu ograničiti i na kraju blokirati dotok
                krvi u vaš mozak, lice i vrat. Blokirana karotidna
                arterija može uzrokovati moždani udar.
              </p>
              <ul className={ul}>
                ...
                <li>
                  Ako idete na operaciju premosnice koronarne arterije
                </li>
                <li>
                  Ako u obitelji imate povijest moždanih udara ili
                  srčanih bolesti
                </li>
              </ul>
            </div>
