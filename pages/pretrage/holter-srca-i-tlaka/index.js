  ...
  return (
    <div>
      <Head>
        ...
        <meta name="keywords" content="neurolog, neurologija, holter srca" />
      ...
      <div id={"main-container"}>
        <div className={wrapper}>
          <SidePicker list1={kardiologija} title={kardiologija[0].name} />
          <div className={subwrapper}>
            <div className={content}>
              <div className={content}>
                <h1 className={title}>{kardiologijaPregledi[1].name}:</h1>
                <p className={text}>{kardiologijaPregledi[1].text}</p>
                <p className={text}>{kardiologijaPregledi[1].text1}</p>
              </div>
              <div className={content}>
                <h2 className={subtitle}>{kardiologijaPregledi[2].name}:</h2>
                <p className={text}>{kardiologijaPregledi[2].text}</p>
                <p className={text}>{kardiologijaPregledi[2].text1}</p>
                <ul className={ul}>
