  ...
  return (
    <div>
      <Head>
        ...
        <meta
          name="keywords"
          content="Vidni evocirani potencijali VEP"
        />
        <meta
          property="og:title"
          content="Vidni evocirani potencijali"
        />
        <meta
          property="og:image"
        ...
        <div className={wrapper}>
          ...
          <div className={subwrapper}>
            <div className={content}>
              ...
              <p className={text}>
                Testom evociranog vizualnog potencijala (VEP)
                provjerava se optički živca koji vodi od očiju do
                mozga.
              </p>
            </div>
            <div className={content}>
              ...
              <p className={text}>
                Vaš će se vid provjeriti i od vas će se tražiti da
                pročitate očnu kartu. Elektrode će vam se pričvrstiti
                na glavu. Jedno vaše oko bit će prekriveno povezom. Na
                zaslonu računala će vam se prikazani crni i bijeli
                kvadrati koji nalikuju šahovskoj ploči. Vidjet ćete
                kako se kvadrati kreću i mijenjaju veličinu tijekom
                testa. Dok ovo gledate, signali iz vašeg mozga će se
                snimati kroz elektrode. Svako oko se testira po
                nekoliko minuta. Test traje između 30 - 60 minuta.
              </p>
            </div>
            <div className={content}>
