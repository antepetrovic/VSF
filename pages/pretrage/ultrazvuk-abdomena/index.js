...
const UltrazvukAbdomena = () => {
  return (
    <div>
      <Head>
        <title>
          Ultrazvuk abdomena i jetre - kada napraviti ultrazvuk abdomena?
        </title>
        <meta
          name="description"
        ...
        <div className={wrapper}>
          ...
          <div className={subwrapper}>
            <div className={content}>
              ...
              <p className={text}>
                Ultrazvuk abdomena provodi se radi utvrđivanja stanja unutarnjih
                organa trbušne šupljine, uključujući bubrege, jetru, žučni
                mjehur, slezenu, gušteraču, nadbubrežne žlijezde, mokraćni
                mjehur, prostatu, organe ženske zdjelice, velike trbušne krvne
                žile, uključujući aortu. te limfni čvorovi i crijeva.
              </p>

              <ul className={ul}>
                <li>
                  Ultrazvuk abdomena omogućuje nam otkrivanje tumora i cista u
                  organima
                </li>
                <li>Dijagnosticiranje izvora boli na koju se pacijent žali</li>
                <li>
                  Ultrazvučnim pregledom trbušne šupljine utvrđujemo jesu li
                  pojedini organi povećani
                </li>
                <li>Procjenjujemo izgled organa</li>
                <li>U slučaju patologija – procjenjujemo stadij bolesti</li>
                <li>
                  Ultrazvuk abdomena nam može pomoći u dijagnosticiranju ima li
                  tekućine u tijelu i abdomenu
                </li>
              </ul>
            </div>
            <div className={content}>
              <h2 className={subtitle}>KADA NAPRAVITI ULTRAZVUK ABDOMENA</h2>
              <ul className={ul}>
                ...
                <li>Krvarenje iz urinarnog trakta, vaginalno krvarenje</li>
