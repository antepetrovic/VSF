  ...
  return (
    <div>
      <Head>
        ...
        <meta
          name="description"
          content="U Poliklinici Petrović u Vrgoracu možete napraviti Color doppler vratnih žila, arterija i vena nogu i ruku i color doppler testisa. Color dopler je bezbolna ultrazvučna pretraga kojom se
        ...
        <meta
          ...
          content="U Poliklinici Petrović u Vrgoracu možete napraviti Color dopler vratnih žila, arterija i vena nogu i ruku i color doppler testisa. Color dopler je bezbolna ultrazvučna pretraga kojom se
          ispituju arterijske i venske žile. Pretraga nam daje
          informaciju o postojanju zadebljanja na stijenkama
          žila."
        />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description:
                "U Poliklinici Petrović u Vrgoracu možete napraviti Color dopler vratnih žila, arterija i vena nogu i ruku i color doppler testisa. Color dopler je bezbolna ultrazvučna pretraga kojom se ispituju arterijske i venske žile. Pretraga nam daje informaciju o postojanju zadebljanja na stijenkama žila.",
              provider: {
        ...
        <div className={wrapper}>
          ...
          <div className={subwrapper}>
            <div className={content}>
              ...
              <p className={text}>
                Color dopler je bezbolna ultrazvučna pretraga kojom se ispituju
                arterijske i venske žile. Pretraga nam daje informaciju o
                postojanju zadebljanja na stijenkama žila uz pomoć mjernja
                brzine i otpora krvi u žili. Doppler ultrazvuk koristi
                visokofrekventne zvučne valove za{" "}
                <b>mjerenje protoka krvi kroz arterije i vene</b>, obično one
                koje krvlju opskrbljuju vaše ruke i noge. Postavljanjem
                ultrazvučne sonde na površinu kože iznad arterija i vena
                dobivamo prikaz strukture krvnih žila.
              </p>{" "}
              <p className={text}>
                Doppler ultrazvuk je bezbolan postupak koji zahtijeva malo
                pripreme. Test pruža vašem liječniku važne informacije o protoku
                krvi kroz vaše glavne arterije i vene. Također može otkriti{" "}
                <b>blokiran ili smanjen</b> protok krvi kroz sužena područja u
                arterijama, što bi na kraju moglo dovesti do moždanog udara.
              </p>
            </div>
            <div className={content}>
            ...
            <div className={content}>
              ...
              <p className={text}>
                Vaš liječnik može predložiti Doppler ultrazvučni pregled:
              </p>
              <ul className={ul}>
              ...
              <p className={text}>
                Doppler ultrazvuk može pomoći u određivanju krvnog tlaka u vašim
                arterijama. Također može pokazati koliko krvi trenutno teče kroz
                vaše arterije i vene.
              </p>
            </div>
            <div className={content}>
              <h2 className={title}>
