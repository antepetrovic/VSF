  ...
  return (
    <div>
      <Head>
        ...
        <meta
          name="description"
          content="U Poliklinici Petrović u Vrgoracu možete napraviti Color doppler žila vrata karotida i vertebralnih arterija. Color doppler krvnih žila vrata i glave je bezbolna,
        ...
        <meta property="og:title" content="Color doppler žila vrata Vrgorac" />
        <meta
          property="og:image"
        ...
        <div className={wrapper}>
          ...
          <div className={subwrapper}>
            <div className={content}>
              <h1 className={title}>Color doppler krvnih žila vrata i glave</h1>
              <p className={text}>
                Color doppler krvnih žila vrata i glave je bezbolna, neinvazivna
                dijagnostička metoda, kojom se mjeri protok krvi kroz krvne žile
                vrata i glave. Ovom metodom se mogu otkriti suženja krvnih žila
                ili njihova proširenja (aneurizme). Na arterijama se mogu
