...
import {
  pretrageList,
  kardioloskiPregled
} from 'public/utils/kardiologija'
        ...
        <div className={wrapper}>
          ...
          <div className={subwrapper}>
            <div className={content}>
              ...
              <p className={text}>
                Kardiološki pregled je bezbolan i nije potrebna
                nikakava posebna priprema prije dolaska, a u pregledu
                se koristi EKG uređaj koji grafički prikazuje rad srca
                u mirovanju i može otkriti razne srčane bolesti. Ako
                liječnik smatra da je potrebno može se napraviti i
                ultrazvuk srca, holter srca i ergometrija
              </p>
            </div>
            ...
            <div className={content}>
              <h2 className={subtitle}>
                {kardioloskiPregled.cijena.title}
              </h2>
              <p className={text}>{kardioloskiPregled.cijena.text}</p>
            </div>
          </div>
        </div>
      </div>
